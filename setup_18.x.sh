...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_14.x вЂ” Node.js 14 \"Fermium\"${normal}
   * ${green}https://deb.nodesource.com/setup_16.x вЂ” Node.js 16 \"Gallium\"${normal}
   * ${green}https://deb.nodesource.com/setup_18.x вЂ” Node.js 18 LTS \"Hydrogen\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_19.x вЂ” Node.js 19 \"Nineteen\"${normal}
   * ${green}https://deb.nodesource.com/setup_20.x вЂ” Node.js 20 \"Iron\"${normal} (current)
